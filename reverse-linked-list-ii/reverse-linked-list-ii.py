...
#         self.next = next
class Solution:
    def reverseBetween(self, head: ListNode, left: int, right: int, prev=None) -> ListNode:
        # Solution: https://leetcode.com/problems/reverse-linked-list-ii/discuss/30732/Python-implementation-and-detailed-explanation
        # Step 1
